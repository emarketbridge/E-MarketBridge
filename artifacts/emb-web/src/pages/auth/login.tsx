    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-foreground">e-MarketBridge</h1>
          <p className="text-muted-foreground text-sm mt-1">Connecting rural Jordan to the world</p>
        </div>
