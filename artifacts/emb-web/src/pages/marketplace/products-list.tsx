...
const CATEGORIES = ["All", "Agriculture", "Handicrafts", "Traditional Food", "Textiles", "Natural Products", "Other"];
        ...
        <CardContent className="p-4">
          ...
          <div className="flex items-center justify-between mt-3">
            ...
            <Button
              ...
              onClick={() => { addToCart(product); toast({ title: `${product.name} added to cart` }); }}
